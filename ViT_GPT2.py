...
#-----------------------------------------------   EPOCH - 1 -----------------------------------------------------
# 'eval_loss': 0.6079602241516113, 
# 'eval_Bleu_score': 0.0084, 
# 'eval_Precisions': [0.016255515732455185, 0.00891433845121235, 0.00655467781136686, 0.005243755997545922], 
# 'eval_Brevity_Penalty': 1.0, 
# 'eval_rouge2_precision': 0.0456, 
# 'eval_rouge2_recall': 0.0677, 
# 'eval_rouge2_fmeasure': 0.0523, 
# 'eval_runtime': 1549.5538, 
# 'eval_samples_per_second': 10.256, 
# 'eval_steps_per_second': 1.282
#-----------------------------------------------   EPOCH - 2 -----------------------------------------------------
# 'eval_loss': 0.6029326915740967, 
# 'eval_Bleu_score': 0.0084, 
# 'eval_Precisions': [0.016255515732455185, 0.00891433845121235, 0.00655467781136686, 0.005243755997545922], 
# 'eval_Brevity_Penalty': 1.0, 
# 'eval_rouge2_precision': 0.0456, 
# 'eval_rouge2_recall': 0.0677, 
# 'eval_rouge2_fmeasure': 0.0523, 
# 'eval_runtime': 1542.403, 
# 'eval_samples_per_second': 10.303, 
# 'eval_steps_per_second': 1.288, 

#-----------------------------------------------   EPOCH - 3 -----------------------------------------------------
# 'eval_loss': 0.8045421242713928, 
# 'eval_rouge2_precision': 0.0509, 
# 'eval_rouge2_recall': 0.0791, 
# 'eval_rouge2_fmeasure': 0.0597, 
# 'eval_runtime': 3060.8046, 
# 'eval_samples_per_second': 10.384, 
# 'eval_steps_per_second': 1.298,
#-----------------------------------------------   EPOCH - 4 -----------------------------------------------------
# 'eval_loss': 0.8101363182067871, 
# 'eval_rouge2_precision': 0.0463, 
# 'eval_rouge2_recall': 0.0608, 
# 'eval_rouge2_fmeasure': 0.0506, 
# 'eval_runtime': 2718.861, 
# 'eval_samples_per_second': 11.69, 
# 'eval_steps_per_second': 1.461,
#-----------------------------------------------   EPOCH - 5 -----------------------------------------------------
# 'eval_loss': 0.8172929883003235, 
# 'eval_rouge2_precision': 0.0509, 
# 'eval_rouge2_recall': 0.0791, 
# 'eval_rouge2_fmeasure': 0.0597, 
# 'eval_runtime': 3044.624, 
# 'eval_samples_per_second': 10.439, 
# 'eval_steps_per_second': 1.305,
#-----------------------------------------------   EPOCH - 6 -----------------------------------------------------
# 'eval_loss': 0.8265484571456909, 
# 'eval_rouge2_precision': 0.0412, 
# 'eval_rouge2_recall': 0.0609, 
# 'eval_rouge2_fmeasure': 0.0474, 
# 'eval_runtime': 2944.6578, 
# 'eval_samples_per_second': 10.793, 
# 'eval_steps_per_second': 1.349,
#-----------------------------------------------   EPOCH - 7 -----------------------------------------------------
# 'eval_loss': 0.8368719220161438, 
# 'eval_rouge2_precision': 0.0494, 
# 'eval_rouge2_recall': 0.061, 
# 'eval_rouge2_fmeasure': 0.0526, 
# 'eval_runtime': 3078.9494, 
# 'evasamples_per_second': 10.323, 
# 'eval_steps_per_second': 1.29,
#-----------------------------------------------   EPOCH - 8 -----------------------------------------------------
# 'eval_loss': 0.846892774105072, 
# 'eval_rouge2_precision': 0.044, 
# 'eval_rouge2_recall': 0.0701, 
# 'eval_rouge2_fmeasure': 0.052, 
# 'eval_runtime': 7281.7953, 
# 'eval_samples_per_second': 4.365, 
# 'eval_steps_per_second': 0.546,
#-----------------------------------------------   EPOCH - 9 -----------------------------------------------------
# 'eval_loss': 0.8577685356140137, 
# 'eval_rouge2_precision': 0.044, 
# 'eval_rouge2_recall': 0.0701, 
# 'eval_rouge2_fmeasure': 0.052, 
# 'eval_runtime': 3060.3517, 
# 'eval_sames_per_second': 10.385, 
# 'eval_steps_per_second': 1.298, 
#-----------------------------------------------   EPOCH - 10 -----------------------------------------------------
# 'eval_loss': 0.8642417192459106, 
# 'eval_rouge2_precision': 0.044, 
# 'eval_rouge2_recall': 0.0701, 
# 'eval_rouge2_fmeasure': 0.052, 
# 'eval_runtime': 3045.6765, 
# 'eval_samples_per_second': 10.435, 
# 'eval_steps_per_second': 1.304, 
# 'train_runtime': 80394.5361, 
# 'train_samples_per_second': 15.814, 
# 'train_steps_per_second': 1.977, 
# 'train_loss': 0.7114217382277885,
#------------------------------------------------------------------------------------------------------------------
